...
const HomePage: React.FC = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-slate-800 bg-contain bg-no-repeat bg-center flex flex-col" 
      style={{ backgroundImage: "url('https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Mapa_de_Colombia_%28departamentos%29.svg/1534px-Mapa_de_Colombia_%28departamentos%29.svg.png')" }}
    >
